...
from labs.lab3_linear_algebra import calculate_2d_vectors_data, calculate_matrix_transformation_data
...
class TestLab3LinearAlgebra(unittest.TestCase):
    ...
    def test_calculate_matrix_transformation_data(self):
        ...
        self.assertTrue(np.array_equal(data['transformed_square'], expected_transformed_square))
        self.assertTrue(np.allclose(data['eigenvalues'], np.array([1., 1.])))
